...
# OBS: Se por acaso ao baixar o repoitório e ele já vier com o arquivo .env, só verifica se está setado para db
em vez de localhost, não tem a necessidade de criar outro.
