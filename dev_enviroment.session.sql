...
COMMENT ON COLUMN Dim_purchances.purchance_type IS 'bulk = purchase for production, warranty = replacement';
ALTER TABLE "Fact_Warranties"
ADD FOREIGN KEY("part_id") REFERENCES "Dim_Parts"("part_id") ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Fact_Warranties"
ADD FOREIGN KEY("vehicle_id") REFERENCES "Dim_Vehicle"("vehicle_id") ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Dim_Suplier"
ADD FOREIGN KEY("suplier_id") REFERENCES "Dim_Parts"("supplier_id") ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Dim_Suplier"
ADD FOREIGN KEY("location_id") REFERENCES "Dim_locations"("location_id") ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Fact_Warranties"
ADD FOREIGN KEY("location_id") REFERENCES "Dim_locations"("location_id") ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Dim_Parts"
ADD FOREIGN KEY("last_id_purchase") REFERENCES "Dim_purchances"("purchance_id") ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE "Fact_Warranties"
ADD FOREIGN KEY("purchance_id") REFERENCES "Dim_purchances"("purchance_id") ON UPDATE NO ACTION ON DELETE NO ACTION;
